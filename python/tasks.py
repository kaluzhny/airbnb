...
def run_model(x_train, y_train, x_test, classes_count, classifier, n_threads, n_seed):
    ...
    classifiers_no_session = [
        ...
        (RandomForestClassifier(n_estimators=200, criterion='gini', n_jobs=n_threads, random_state=n_seed), False, 'rfc200'),
        ...
        # (ExtraTreesClassifier(n_estimators=300, criterion='entropy', n_jobs=n_threads, random_state=n_seed), False, 'etc300_e'),
        (ExtraTreesClassifier(n_estimators=400, criterion='gini', n_jobs=n_threads, random_state=n_seed), False, 'etc400'),
        (ExtraTreesClassifier(n_estimators=400, criterion='entropy', n_jobs=n_threads, random_state=n_seed), False, 'etc400_e'),
    ...
    classifiers_session = [
        ...
        (RandomForestClassifier(n_estimators=200, criterion='gini', n_jobs=n_threads, random_state=n_seed), False, 'rfc200_2014'),
        ...
        # (ExtraTreesClassifier(n_estimators=300, criterion='entropy', n_jobs=n_threads, random_state=n_seed), False, 'etc300_e_2014'),
        (ExtraTreesClassifier(n_estimators=400, criterion='gini', n_jobs=n_threads, random_state=n_seed), False, 'etc400_2014'),
        (ExtraTreesClassifier(n_estimators=400, criterion='entropy', n_jobs=n_threads, random_state=n_seed), False, 'etc400_e_2014'),
