...
def get_model_classifiers(n_threads, n_seed):
    ...
    classifiers_2014 = [
        ...
        (AdaBoostClassifier(base_estimator=ExtraTreesClassifier(n_estimators=100, n_jobs=n_threads, random_state=n_seed), random_state=n_seed), False, False, 'adaetc100_2014'),
        ...
        # (ExtraTreesClassifier(n_estimators=800, criterion='gini', n_jobs=n_threads, random_state=n_seed), False, False, 'etc800_2014'),
        (RandomForestClassifier(n_estimators=1000, criterion='gini', n_jobs=n_threads, random_state=n_seed), False, False, 'rfc1000_2014'),
        (ExtraTreesClassifier(n_estimators=1000, criterion='gini', n_jobs=n_threads, random_state=n_seed), False, False, 'etc1000_2014'),
        ...
        # (XGBClassifier(objective='multi:softprob', max_depth=5, n_estimators=100, learning_rate=0.1, nthread=n_threads, seed=n_seed), False, False, 'xg5softprob100_2014'),
        # (XGBClassifier(objective='multi:softprob', max_depth=3, n_estimators=100, learning_rate=0.1, nthread=n_threads, seed=n_seed), False, True, 'xg3softprob100log_2014'),
        # (KNeighborsClassifier(n_neighbors=16, p=1, n_jobs=n_threads), False, True, 'knn_16p1_2014'),
        ...
        # (KNeighborsClassifier(n_neighbors=16, p=2, n_jobs=n_threads), False, True, 'knn_16p2_2014'),
        # (KNeighborsClassifier(n_neighbors=32, p=2, n_jobs=n_threads), False, True, 'knn_32p2_2014'),
        # (KNeighborsClassifier(n_neighbors=64, p=2, n_jobs=n_threads), False, True, 'knn_64p2_2014'),
        # (KNeighborsClassifier(n_neighbors=128, p=2, n_jobs=n_threads), False, True, 'knn_128p2_2014'),
...
def run_model(x_train, y_train, x_test, classes_count, classifier, n_threads, n_seed, cache_dir):
    ...
    bag = BaggingClassifier(base_estimator=xgb, n_estimators=5, random_state=n_seed, verbose=10)
